...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/es/object/assign'), require('core-js/es/number/is-nan')) :
  typeof define === 'function' && define.amd ? define(['core-js/es/object/assign', 'core-js/es/number/is-nan'], factory) :
  ...
  var script$4 = {
    ...
    computed: {
      ...
      prevMonthDays: function prevMonthDays() {
        ...
        var daysInPrevMonth = this.utils.daysInMonth(
          this.utils.getFullYear(dObj), this.utils.getMonth(dObj) - 1
        );

        var totalLastDays = this.utils.getDay(dObj);
        ...
        for (var i = daysInPrevMonth - totalLastDays; i <= daysInPrevMonth; i += 1) {
          days.push({
            date: i,
      ...
      nextMonthDays: function nextMonthDays() {
        ...
        var totalRenderedDates = this.prevMonthDays.length + this.days.length;
        var totalRow = Math.ceil(totalRenderedDates / 7);
        var totalCompleteCells = totalRow * 7;
        var totalMissingCells = totalCompleteCells - totalRenderedDates;

        var days = [];

        for (var i = 1; i <= totalMissingCells; i += 1) {
          days.push({
            date: i,
            key: ((this.utils.getMonth(dObj) + 1) + "-" + i),
          });
  ...
  var __vue_render__$2 = function() {
    ...
    return _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", { class: _vm.isRtl ? "flex-rtl" : "" }, [
          _c(
            "div",
          ...
          _c(
            ...
            [
              _vm._l(_vm.prevMonthDays, function(day) {
                return _c("span", {
                  key: day.key,
                  staticClass: "cell day prevmonthday disabled",
              ...
              _vm._l(_vm.nextMonthDays, function(day) {
                return _c("span", {
                  key: day.key,
                  staticClass: "cell day nextmonthday disabled",
                  domProps: { innerHTML: _vm._s(_vm.dayCellContent(day)) }
                })
              })
            ],
  ...
  var script$6 = {
    ...
    computed: {
      ...
      getPageDecade: function getPageDecade() {
        var decadeStart = Math.floor(this.utils.getFullYear(this.pageDate) / YEAR_RANGE) * YEAR_RANGE;
        var decadeEnd = decadeStart + (YEAR_RANGE - 1);
        var ref = this.translation;
        var yearSuffix = ref.yearSuffix;
